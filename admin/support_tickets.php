...
require_once __DIR__ . '/../config/config.php';
requireAdminCapability('tickets.manage');
    ...
    <table class="data-table" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php /* Classes, not inline styles — and the cell needs a wrapping rule,
                         not just a width. Everything printed here is text a customer
                         typed, and one ticket holds a 5,000-character run with no spaces;
                         a browser will not break inside a word unless told to, so the
                         cell stretched, the table went with it, and every other column
                         was pushed off the screen. */ ?>
                <td class="ticket-content-cell">
                    <strong class="ticket-content-subject"><?= htmlspecialchars($t['subject']) ?></strong>
                    <span class="ticket-content-message"><?= htmlspecialchars($t['message']) ?></span>
