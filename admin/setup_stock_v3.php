...
// config FIRST — requireAdminCapability() is defined in it.
//
// The capability check sat one line ABOVE these requires, so the function did
// not exist yet and the page died with "Call to undefined function
// requireAdminCapability()" for everyone, owner included. The guard was
// therefore never reached and never enforced; the fatal was the only thing
// stopping the migrations from running.
