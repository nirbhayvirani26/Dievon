...
if ($module === 'homepage_builder') {
    header('Location: homepage_builder.php');
    exit;
}
if ($module === 'seo') {
...
$moduleTitles = [
    'homepage_builder' => 'Homepage Section Builder',
...
<div class="admin-page-header" style="margin-bottom: 24px;">
    ...
    <p class="admin-page-subtitle">Configure and manage <?= strtolower($title) ?> settings for Dievon Atelier.</p>
</div>
...
<div class="glass-panel" style="padding: 28px;">
    ...
    <?php if ($module === 'admin_users'): ?>
        <div style="margin-bottom: 20px; padding: 18px; background: var(--bg-surface-soft); border: 1px solid var(--border-light); border-radius: 8px;">
            ...
            <span style="font-size: 13px; color: var(--text-secondary);"><i class="fa-solid fa-user-shield"></i> <strong><?= htmlspecialchars(ADMIN_USERNAME) ?></strong> (Super Administrator) — Full System Access</span>
        </div>
    <?php endif; ?>
